...
| 功能 | 文件位置 | 优先级 | 状态 | 依赖 |
|------|---------|--------|------|------|
| 在线文档 URL | `main_window.py:1224` | 低 | 🔲 | 文档服务器 |

**备注**: 替换 placeholder URL 为项目实际文档链接
...
- [x] 相关文档已更新 (本文档)
- [x] 原有 511 个测试无回归
- [ ] 剩余 TODO (计划任务/文档URL/轨道计算/模型架构) 需继续实现
